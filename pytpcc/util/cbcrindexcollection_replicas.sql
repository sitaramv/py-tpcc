...
drop index ORDERS.OR_W_ID_D_ID_C_ID_O_ID USING GSI
...
CREATE INDEX OR_W_ID_D_ID_C_ID_O_ID on ORDERS(O_W_ID, O_D_ID, O_C_ID, O_ID DESC) USING GSI WITH {"defer_build": true, "num_replica":replicas}
